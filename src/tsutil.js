...
var TypeScriptUtil;
(function (TypeScriptUtil) {
    var MochaBddFormatter = (function (_super) {
        __extends(MochaBddFormatter, _super);
        function MochaBddFormatter(inspector, indent) {
                _super.call(this, inspector, indent);
        }
        MochaBddFormatter.prototype.format = function (rootName) {
            var str = this.formatClasses();
            str += this.formatModule(rootName, this.inspector.structure, 0, '');
            return str;
        };
        MochaBddFormatter.prototype.formatClasses = function () {
            var self = this;
            var str = '';
            self.inspector.classes.forEach(function (cl) {
                str += self.formatString('class {0}', cl.type);
        ...
        MochaBddFormatter.prototype.formatClassMembers = function (obj) {
            var self = this;
            var props = Object.getOwnPropertyNames(obj);
            var str = '';
            props.forEach(function (prop) {
        ...
        MochaBddFormatter.prototype.encodeString = function (str) {
            return str.replace(/'/g, '\'').replace(/"/g, '"');
        };
        MochaBddFormatter.prototype.formatModule = function (name, attributes, depth, ancestors) {
            var self = this;
            var str = '';
        ...
        MochaBddFormatter.prototype.formatModuleMembers = function (obj, depth, ancestors) {
            var self = this;
            var props = Object.getOwnPropertyNames(obj);
            var str = '';
            props.forEach(function (prop) {
        ...
        return MochaBddFormatter;
    })(TypeScriptUtil.ObjectInspectorFormatter);
    TypeScriptUtil.MochaBddFormatter = MochaBddFormatter;    
    function toMochaBdd(obj, name, maxIterations) {
        var str = '';
        var insp = new TypeScriptUtil.ObjectInspector(obj, maxIterations);
        var hier = insp.inspect();
    ...
    TypeScriptUtil.toMochaBdd = toMochaBdd;
})(TypeScriptUtil || (TypeScriptUtil = {}));
if(typeof exports !== 'undefined') {
